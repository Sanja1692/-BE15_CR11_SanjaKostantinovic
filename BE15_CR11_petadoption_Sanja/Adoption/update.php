...
if (isset($_POST["submit"])) {
    ...
    if ($pictureArray->error === 0) {
        ...
        $sql = "UPDATE users SET fname = '$fname', lname = '$lname', picture = '$pictureArray->fileName', phone = '$phone', address = '$address', email = '$email' WHERE id = {$id}";
    } else {
        $sql = "UPDATE users SET fname = '$fname', lname = '$lname', phone = '$phone', address = '$address', email = '$email' WHERE id = {$id}";
    }
