...
$error = false;
$fname = $lname = $picture = $phone = $address = $email = $pass = '';
$fnameError = $lnameError = $picError = $phoneError =  $addressError = $emailError = $passError = '';
if (isset($_POST['btn-signup'])) {
    ...
    if (!$error) {
        ...
        $query = "INSERT INTO users(fname, lname, picture, phone, address, email, password )
        VALUES('$fname', '$lname', '$picture->fileName', '$phone', '$address', '$email', '$password')";
...
<body>
    <div class="container">
        <form class="w-75" method="post" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" autocomplete="off" enctype="multipart/form-data">
            ...
            <input type="number" name="phone" class="form-control" placeholder="Enter Your Phone Number" maxlength="50" value="<?php echo $phone ?>" />
